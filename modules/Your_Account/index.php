...
function userinfo($username, $bypass=0, $hid=0, $url=0) {
	...
	title("-> Benvenuto su ZEUS <i>".htmlentities($username)."</i> <-");
	...
	echo "<tr>";
		...
		<div class=image style=background-image:url('images/clienti.png');width:256px;height:256px;position:inline-block;>
			<div class=title style=position: static;bottom: 0px;width: 100%;overflow: none;>Clienti</div>
		</div></a>
		</td>";
		...
		<div class=image style=background-image:url('images/lloyds.png');width:256px;height:256px;position:inline-block;>
			<div class=title style=position: static;bottom: 0px;width: 100%;overflow: none;>LLoyd'S</div>
		</div></a>
		</td>";
		...
		<div class=image style=background-image:url('images/vita.png');width:256px;height:256px;position:inline-block;>
			<div class=title style=position: static;bottom: 0px;width: 100%;overflow: none;>Vita</div>
		</div></a>
		</td>";
	echo "</tr>";
	echo "<tr>";
		...
		<div class=image style=background-image:url('images/ramigenerali.png');width:256px;height:256px;position:inline-block;>
			<div class=title style=position: static;bottom: 0px;width: 100%;overflow: none;>Rami Generali</div>
		</div></a>
		</td>";
		...
		<div class=image style=background-image:url('images/parametri.png');width:256px;height:256px;position:inline-block;>
			<div class=title style=position: static;bottom: 0px;width: 100%;overflow: none;>Parametri</div>
		</div></a>
		</td>";
		...
		<div class=image style=background-image:url('images/logout.png');width:256px;height:256px;position:inline-block;>
			<div class=title style=position: static;bottom: 0px;width: 100%;overflow: none;>Esci</div>
		</div></a>
		</td>";
	echo "</tr>";
	echo "</table></center>";
	CloseTable();
	$pippo='1';
	include("/gestionale/scadenze.php");
	include("footer.php");
}
...
function main($user) {
	...
	if(!is_user($user)) {
		...
		if ($stop) {
			...
			OpenTable();
			echo "<center><font class=\"title\"><b>Login utenti</b></font></center>\n";
			CloseTable();
			echo "<br>\n";
		}
		if (!is_user($user)) {
			...
			echo "<form action=\"modules.php?name=$module_name\" method=\"post\">\n"
			."<p><center>Inserisci le informazioni di accesso per entrare nel sistema</center></p>\n"
			."<center><table border=\"0\"><tr><td align=center>\n"
			."Username<br><input type=\"text\" name=\"username\" size=\"15\" maxlength=\"25\"></td></tr>\n"
			."<tr><td align=center>"._PASSWORD."<br><input type=\"password\" name=\"user_password\" size=\"15\" maxlength=\"20\"></td></tr>\n";
			echo "</table><input type=\"hidden\" name=\"redirect\" value=\"$redirect\">\n"
			."<input type=\"hidden\" name=\"mode\" value=$mode>\n"
			."<input type=\"hidden\" name=\"f\" value=$f>\n"
			."<input type=\"hidden\" name=\"t\" value=$t>\n"
			."<input type=\"hidden\" name=\"op\" value=\"login\">\n"
			."<center><input type=\"submit\" value=\""._LOGIN."\"></center></form>\n\n";
			CloseTable();
		}
		include("footer.php");
	} elseif (is_user($user)) {
