	...
	function downloads() {
		...
		if ($numrows>0) {
			...
			while($row4 = $db->sql_fetchrow($result4)) {
				...
				$filesize = filter($row4['filesize'], "nohtml");
				$version = filter($row4['version'], "nohtml");
				$homepage = filter($row4['homepage'], "nohtml");
				if ($submitter == "") {
					$submitter = _NONE;
				}
				...
				."" . _FILEURL . ": <input type=\"text\" name=\"url\" value=\"$url\" size=\"50\" maxlength=\"100\">&nbsp;[ <a href=\"index.php?url=$url2\" target=\"_blank\">" . _CHECK . "</a> ]<br>"
				...
				."" . _HOMEPAGE . ": <input type=\"text\" name=\"homepage\" size=\"30\" maxlength=\"200\" value=\"http://$homepage\"> [ <a href=\"index.php?url=http://$homepage2\">" . _VISIT . "</a> ]<br>";
