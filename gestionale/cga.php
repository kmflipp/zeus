...
function modify(id,scrolltop,ord,pag) {
	window.location='gestionale.php?name=parametri&subname=cga&ord='+ord+'&pag='+pag+'&act=mod&id='+id+'&scrolltop='+scrolltop;
}
function remove(id,scrolltop,ord,pag) {
	...
	if (x) window.location='gestionale.php?name=parametri&subname=cga&ord='+ord+'&pag='+pag+'&act=del&id='+id+'&scrolltop='+scrolltop;
}
</script>
<?php
...
title("$sitename: Parametri <i>Condizioni Generali di Assicurazione</i>");
?>
	<script>
...
OpenTable();
	echo '<p>';
	echo '<input type=button value="Nuovo Record" onclick="location.href=' . chr(39) . 'gestionale.php?act=new&name=parametri&subname=cga&ord=' . $ord . '&pag='. $pag . chr(39) . '" style="font-family: Verdana; font-size: 10px">';
	echo '<input type=button value="Mostra tutti i record" onclick="location.href=' . chr(39) . 'gestionale.php?name=parametri&subname=cga' . chr(39) . '" style="font-family: Verdana; font-size: 10px">';
	echo '</p>';
	...
	if ($act == 'new') {
		echo '<form action=gestionale.php method=post enctype="multipart/form-data"><input type=hidden name=ord value=' . $ord . '><input type=hidden name=pag value=' . $pag . '><input type=hidden name=act value=savnew><input type=hidden name=name value=parametri><input type=hidden name=subname value=cga>';
		echo '<tr>';
